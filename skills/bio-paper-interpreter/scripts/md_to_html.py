...
def build_footer_image_html(image_path):
    """Return a poster figure block with base64-encoded image at page end, or empty string."""
    if not image_path or not os.path.exists(image_path):
        return ''
    import base64
    with open(image_path, 'rb') as f:
...
def main():
    ...
    parser.add_argument('--image', '-img', default=None,
